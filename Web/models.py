...
class market_price(models.Model):
	...
	# isAdminEnablePayLater = models.CharField(max_length=45,verbose_name="isAdminEnablePayLater",blank=True,null=True)
	# isAdminEnablePremiumDeposit = models.CharField(max_length=45,verbose_name="isAdminEnablePremiumDeposit",blank=True,null=True)
...
class Premium_TransactionHistory(models.Model):
    ...
    class Meta:
        db_table = "Premium_TransactionHistory"
        indexes = [
